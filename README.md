...
This project was made in the COM-490 course.

We built a robust journey planner in Zürich, providing journey from a starting point to a destination with the confidence interval that the journey will take place (i.e., that there will not be delay or missed connections) based on historical data from the past 5 years.

We modelized Zürich public transportation data in a graph, and applied big data transformation and machine learning to provide the journey planner.
